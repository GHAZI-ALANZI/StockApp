...
using StockApp.Common.Enums;
using StockApp.Common.Message;
using StockApp.Core.Service;
using StockApp.Core.UnitOfWorks;
using StockApp.Model.Domain;
using StockApp.Model.Service;
using StockApp.Service.Base;
using Entity = StockApp.Data.Entity;

namespace StockApp.Service.Transaction
{

...
using StockApp.Repository.Category;
using StockApp.Repository.Product;
using StockApp.Repository.Store;
using StockApp.Repository.StoreStock;
using StockApp.Repository.Transaction;
using StockApp.Repository.TransactionDetail;
using StockApp.Repository.TransactionType;
using StockApp.Repository.UnitOfMeasure;
using StockApp.Repository.User;

namespace StockApp.UnitOfWork
{

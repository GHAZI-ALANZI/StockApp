    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(5177), "EX01", "Example Store" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(3753), "Stock Receipt" },
                    { 2, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(3765), "Stock Out" },
                    { 3, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(3766), "Transfer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(4003), "pc", "Piece" },
                    { 2, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(4012), "kg", "Kilogram" },
                    { 3, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(4016), "m", "Meter" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Surname" },
                values: new object[] { 1, new DateTime(2024, 5, 4, 13, 28, 28, 901, DateTimeKind.Local).AddTicks(5011), "admin@admin.com", "Admin", "827ccb0eea8a706c4c34a16891f84e7b", "Admin" });
